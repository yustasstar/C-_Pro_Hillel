...
//class Program1
//{
//    delegate void Message1(); // 1. Оголошуємо делегат в клвссе
//    static void Main()
//    {
//        Message1 mes; // 2. Створюємо змінну делегата 
//        mes = Hello; // 3. Привласнюємо цю змінну адресу методу
//        mes(); // 4. Викликаємо метод
...
//var operation2 = new Operation(Add);
...
////Цьому делегату відповідає  перший  метод:
...
//// Якщо делегат повертає деяке значення, то повертається значення только останнього методу зі списку викликiв
...
//// * Узагальнені делегати (Generic Delegate)
...
//        case OperationType.Multiply: return (x, y) => x * y;
//        default: return (x, y) =>;
//    }
//}
//enum OperationType
...
//// #1. вкладена функція, яка використовує змінні та параметри зовнішньої функції
//// #2. змінні та параметри (лексичне оточення), які визначені у зовнішній функції
//// #3. зовнішня функція, яка визначає деяку область видимості та в якій визначені деякі змінні та параметри - лексичне оточення
...
//Action Outer() // метод чи зовнішня функція         // #1
//{
//    int x = 5; // лексичне оточення – локальна змінна
//    void Inner() // локальна функція                // #1
//    {
//        x++; // Операції з лексичним оточенням      // #2
//        Console.WriteLine(x);                       // #2
//    }
//    return Inner; // Повертаємо локальну функцію    // #3
//}
...
//{
//    int x = 10;
//    var innerFn = () => Console.WriteLine(++x); //#2
//    return innerFn;                             //#3
//};
