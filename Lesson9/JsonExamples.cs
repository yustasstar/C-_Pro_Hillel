...
//а token встановлює CancellationToken для скасування завдання. Повертається десеріалізований об'єкт, загорнутий у ValueTask
...
//Серіалізації підлягають лише суспільні характеристики об'єкта (з модифікатором public).
