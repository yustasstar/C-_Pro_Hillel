...
//XmlText: представляє значення елемента у вигляді тексту, тобто той текст,
//який знаходиться в елементі між його тегами, що відкривають і закривають
...
//Властивість Attributes повертає об'єкт XmlAttributeCollection, який представляє колекцію атрибутів
...
//Властивість Name повертає назву вузла. Наприклад, <user> - значення властивості Name і "user"

//Властивість ParentNode повертає батьківський вузол біля поточного вузла
...
//вибір всіх вузлів з певним ім'ям, у разі з ім'ям "person"

//@name

//вибір атрибута поточного вузла, після знака @ вказується назва атрибута (у разі "name")
...
//вибір певного дочірнього вузла за індексом, у разі третього вузла

////person

//вибір у документі всіх вузлів з ім'ям "person"

//person[@name='Tom']

//вибір елементів із певним значенням атрибута. У разі вибираються все елементи " personal " з атрибутом name='Tom'

//person[company='Microsoft']

//вибір елементів із певним значенням вкладеного елемента. 
//В даному випадку вибираються всі елементи "person", у яких дочірній елемент "company" має значення 'Microsoft'
...
//    Ключовим класом є XElement, який дозволяє отримувати вкладені елементи та керувати ними.
//    Серед його методів можна назвати такі:
